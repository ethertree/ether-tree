  ...
  rows: [
      ...
      content: (
        <div>
          ...
          <div>
            ...
            <p>
              You can use CryptoKitties from multiple computers as long as you have your digital wallet installed on
              both.
            </p>
          </div>
        </div>
    ...
    },
    {
      ...
      content: (
        <div>
          <p>
            <h1>Installing your digital wallet</h1>
            <ul>
              <li>
                To use CryptoKitties, you need a digital wallet. We support all digital wallets, but recommend{" "}
                <a href="https://www.meetdapper.com/?utm_source=twitter&amp;utm_medium=organicsocial&amp;utm_campaign=meetdapper">
                  Dapper
                </a>{" "}
                for the best CryptoKitties experience.{" "}
              </li>
              <li>
            ...
            <p>
              Your public wallet address (e.g. 0xaba935f589805095a892ecefdb6eb83eff45d67) is a unique identifier for
    ...
    },
    {
      ...
      content: (
        <div class="Collapse-body">
          <p>
            <h2 id="whats-ether-eth-why-do-i-need-it">What’s ether (ETH)? Why do I need it?</h2>
            <ul>
              <li>
                Ether is a digital currency that powers the Ethereum network, which is what CryptoKitties is built on.
              ...
              <li>
                ...
                CryptoKitties — on the Ethereum network.
              </li>
            </ul>
          </p>
        </div>
